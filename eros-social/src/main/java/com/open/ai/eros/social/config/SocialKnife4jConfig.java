package com.open.ai.eros.social.config;
...
public class SocialKnife4jConfig {


    private ApiInfo erosAi() {
        return new ApiInfoBuilder()
                .title("社交模块")
                .description("ErosAI项目 和用户进行交流")
                .version("1.0")
    ...
    public Docket erosAiApiConfig() {
        ...
        Docket webApi = new Docket(DocumentationType.SWAGGER_2)
                ...
                .select()
                //只显示api路径下的页面
                .apis(RequestHandlerSelectors.basePackage("com.open.ai.eros.social"))
                .paths(PathSelectors.regex("/eros/ai/social/.*"))
                .build()
