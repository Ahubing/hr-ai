...
public class ErosAIKnowledgeSwagger2Config {


    private ApiInfo erosAi() {
        return new ApiInfoBuilder()
                .title("知识库模块")
                .description("ErosAI知识库")
                .version("1.0")
    ...
    public Docket knowledgeApiConfig() {
        ...
        tokenPar.name(CommonConstant.USER_LOGIN_TOKEN)
                .description("用户token")
                .defaultValue("test-system@gamil.com")
        ...
        Docket webApi = new Docket(DocumentationType.SWAGGER_2)
                ...
                .select()
                //只显示api路径下的页面
                .apis(RequestHandlerSelectors.basePackage("com.open.ai.eros.knowledge"))
                .paths(PathSelectors.regex("/eros/ai/knowledge/.*"))
                .build()
