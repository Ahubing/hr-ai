...
public class ErosAIPaySwagger2Config {


    private ApiInfo erosAi() {
        return new ApiInfoBuilder()
                .title("支付模块")
                .description("ErosAI项目支付")
                .version("1.0")
    ...
    public Docket payApiConfig() {
        ...
        Docket webApi = new Docket(DocumentationType.SWAGGER_2)
                ...
                .select()
                //只显示api路径下的页面
                .apis(RequestHandlerSelectors.basePackage("com.open.ai.eros.pay"))
                .paths(PathSelectors.regex("/eros/ai/pay/.*"))
                .build()
