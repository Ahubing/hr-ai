package com.open.ai.eros.text.match.config;
...
public class TextMatchKnife4jConfig {


    private ApiInfo erosAi() {
        return new ApiInfoBuilder()
                .title("文本匹配模块")
                .description("ErosAI项目文本匹配")
                .version("1.0")
    ...
    public Docket erosAiApiConfig() {
        ...
        Docket webApi = new Docket(DocumentationType.SWAGGER_2)
                ...
                .select()
                //只显示api路径下的页面
                .apis(RequestHandlerSelectors.basePackage("com.open.ai.eros.text.match"))
                .paths(PathSelectors.regex("/eros/ai/text/match/.*"))
                .build()
